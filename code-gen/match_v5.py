...
class ChallengesDto(BaseModel):
    ...
    baronBuffGoldAdvantageOverThreshold: Optional[float] = None
    ...
    fasterSupportQuestCompletion: Optional[float] = None
    fastestLegendary: Optional[float] = None
    hadAfkTeammate: Optional[float] = None
    highestChampionDamage: Optional[float] = None
    highestCrowdControlScore: Optional[float] = None
    highestWardKills: Optional[float] = None
    junglerKillsEarlyJungle: Optional[float] = None
    killsOnLanersEarlyJungleAsJungler: Optional[float] = None
    ...
    mostWardsDestroyedOneSweeper: Optional[float] = None
    mythicItemUsed: Optional[float] = None
    playedChampSelectPosition: Optional[float] = None
    soloTurretsLategame: Optional[float] = None
    takedownsFirst25Minutes: Optional[float] = None
    teleportTakedowns: Optional[float] = None
    thirdInhibitorDestroyedTime: Optional[float] = None
    threeWardsOneSweeperCount: Optional[float] = None
    visionScoreAdvantageLaneOpponent: Optional[float] = None
    InfernalScalePickup: Optional[float] = None
